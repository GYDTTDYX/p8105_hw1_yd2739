...
But for char vector, it says NAs introduced by coercion when executing, and it 
cannot be transformed to numeric vector. So it is reasonable that we cannot calculate
the mean of char vector. 
But for factor vector, the  transformation to numeric form seems successes. 
So it is still not sure why we cannot calculate the mean of the factor vector